namespace ExemploInterpolacaoDeStrings
{
    public class Pessoa
    {
        // metodo construtor
        ...
        public string Nome
        {
            ...
            set
            {
                if (value == "")
                {
                    throw new ArgumentException("O Campo de nome não deve ser vazio.");
                }
                this._nome = value;
            }
        }
        public string Sobrenome{ get; set; }
        public string NomeCompleto => $"{this._nome} {this.Sobrenome}";
        public int Idade
        {
            get => this._idade;
